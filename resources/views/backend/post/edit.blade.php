                ...
                <form class="forms-sample" action="{{ route('update.post', $data->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="form-group col-md-12">
                            ...
                            <textarea class="form-control" name="short_details_en" id="summernote2" rows="4">{{ $data->short_details_en }}</textarea>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-md-12">
                            <label for="exampleTextarea1">Short Details Bangla<small class="text-danger"> ( Optional )</small></label>
                            <textarea class="form-control" name="short_details_ban" id="summernote3" rows="4">{{ $data->short_details_ban }}</textarea>
                        </div>
                    </div>
                    <hr>
