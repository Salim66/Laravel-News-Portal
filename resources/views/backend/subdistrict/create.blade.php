        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                ...
                <form class="forms-sample" action="{{ route('store.subdistrict') }}" method="POST">
                    @csrf
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="subdistrict_ban" placeholder="SubDistrict Bangla">
                  ...
                  <div class="form-group">
                    ...
                    <select name="district_id" class="form-control" id="exampleSelectGender">
                      ...
                      <option value="{{ $dist->id }}">{{ $dist->district_en }} | {{ $dist->district_ban }}</option>
                      @endforeach
                    </select>
                  </div>
