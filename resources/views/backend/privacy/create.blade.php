        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                ...
                <form class="forms-sample" action="{{ route('store.privacy') }}" method="POST">
                    @csrf
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="question_ban">
                  </div>
                  <div class="row">
                    <div class="form-group col-md-12">
                            <label for="exampleTextarea1">Answer English</label>
                            <textarea class="form-control" name="answer_en" id="summernote" rows="4"></textarea>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-md-12">
                            <label for="exampleTextarea1">Answer Bangla</label>
                            <textarea class="form-control" name="answer_ban" id="summernote1" rows="4"></textarea>
                        </div>
                    </div>
