            ...
            <div class="card">
              <div class="card-body">
                <div class="template-demo">
                    <h4 class="card-title float-left">Ads</h4>
                    <a href="{{ route('add.ads') }}" class="btn btn-primary btn-fw float-right mb-4">+ Add Ads</a>
                </div>
                  ...
                  <table id="table_id" class="table table-bordered table-striped">
                    ...
                    @foreach($all_data as $data)
                      <tr>
                        <td> {{ $loop->index+1 }} </td>
                        <td> {{ $data->link }} </td>
                        <td class="text-center"> <img src="{{ URL::to($data->ads) }}" height="80px" width="100px" alt=""> </td>
                        <td>
                            @if($data->type == 2)
